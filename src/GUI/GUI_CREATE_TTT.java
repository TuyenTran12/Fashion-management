...
public class GUI_CREATE_TTT extends javax.swing.JFrame {

  
    public GUI_CREATE_TTT() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            cs.close();
            JOptionPane.showMessageDialog(null, "Đã thêm dữ liệu thành công vào bảng", "Thành công", JOptionPane.INFORMATION_MESSAGE);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Lỗi khi thêm dữ liệu vào bảng" + ex.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                if (rs != null) rs.close();
                if (cs != null) cs.close();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_CREATE_TTT().setVisible(true);                
            }
        });
    }
