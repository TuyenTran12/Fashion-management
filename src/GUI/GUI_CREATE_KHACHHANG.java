...
public class GUI_CREATE_KHACHHANG extends javax.swing.JFrame {

  
    public GUI_CREATE_KHACHHANG() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("SDT_KH");

        jScrollPane3.setViewportView(txtSdt);

        jScrollPane4.setViewportView(txtAddress);

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("DIACHI_KH");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        System.out.print("Tên user :"+user_name);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Connection con = null;
        String user_name = Dataservice.user;
        String ColumnNames =jLabel2.getText() + "," + jLabel3.getText() + "," + jLabel4.getText() + "," + jLabel5.getText() ;
        String ColumnValues = "'" + txtMa.getText() + "','" + txtName.getText() + "','" + txtSdt.getText() + "','" + txtAddress.getText() + "'";
        try {
            ...
            cs.close();
            System.out.print("Tên user :"+user_name);
            JOptionPane.showMessageDialog(null, "Đã thêm dữ liệu thành công vào bảng KhachHang.", "Thành công", JOptionPane.INFORMATION_MESSAGE);
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Lỗi khi thêm dữ liệu vào bảng KhachHang: " + ex.getMessage(), "Lỗi", JOptionPane.ERROR_MESSAGE);
        } finally {
            try {
                if (rs != null) rs.close();
                if (cs != null) cs.close();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_CREATE_KHACHHANG().setVisible(true);                
            }
        });
    }
